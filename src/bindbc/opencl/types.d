...
version(CL_10)             enum clSupport = CLSupport.cl10;
else version(CL_11)        enum clSupport = CLSupport.cl11;
else version(CL_12)        enum clSupport = CLSupport.cl12;
else version(CL_20)        enum clSupport = CLSupport.cl20;
else version(CL_21)        enum clSupport = CLSupport.cl21;
else version(CL_22)        enum clSupport = CLSupport.cl22;
else                       enum clSupport = CLSupport.cl22;
